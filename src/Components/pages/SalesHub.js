        ...
        <>
            ...
            <div>
                <div className="py-3 px-32 mb-7">
                    ...
                    <p className="inline ml-4 font-light text-sm">Sales Hub</p>
                </div>
                <div className="flex m-auto max-w-5xl">
                    <div className="img-div">
                        <img
                            src="https://www.hubspot.com/hs-fs/hubfs/Sales-Hub-Featured-Image-EN@2x.png?width=1164&height=922&name=Sales-Hub-Featured-Image-EN@2x.png"
                            alt="Sales hub"
              ...
              <span className="ml-64 text-blue-500 font-semibold text-2xl">
                ...
                <div className="trustedby pt-28 m-auto max-w-4xl">
                    <h1 className="text-center text-blue-950 text-base font-bold">
                        177,000+ COMPANIES TRUST HUBSPOT
                    </h1>
                    <div className="logos flex mt-5">
                        <img
                            src="https://www.hubspot.com/hubfs/Reseller%20Ratings.png"
                            alt=""
                            className="h-11 w-24"
                        />
                        <img
                            src="https://www.hubspot.com/hubfs/HBK%20CPA%20for%20HS%20Website.png"
                            alt=""
                            className="h-10 w-20 ml-6"
                        />
                        <img
                            src="https://www.hubspot.com/hubfs/Kelly%20Services%20for%20HS%20Website.png"
                            alt=""
                            className="h-10 w-20 ml-6"
                        />
                        <img
                            src="https://www.hubspot.com/hubfs/International%20Web/logos/Kahoot_Logo.png"
                            alt=""
                            className="h-10 w-20 ml-6"
                        />
                        <img
                            src="https://www.hubspot.com/hubfs/IDEO%20for%20HS%20Website.png"
                            alt=""
                            className="h-7 mt-2 w-20 ml-6"
                        />
                        <img
                            src="https://www.hubspot.com/hubfs/Creative%20Circle%20for%20HS%20Website.png"
                            alt=""
                            className="h-10 w-20 ml-5"
                        />
                        <img
                            src="https://www.hubspot.com/hubfs/The%20Linux%20Foundation.png"
                            alt=""
                            className="h-10 w-20 ml-6"
                        />
                        <img
                            src="https://www.hubspot.com/hubfs/SANDLER_Wordmark_2%20Color_SM%20(3).png"
                            alt=""
                            className="h-10 w-20 ml-6"
                        />
                    </div>
                ...
                <div className="flex m-auto max-w-5xl">
                    <div className="content max-w-[50%] mt-24">
                        <h2 className="text-3xl font-bold text-blue-950 max-w-md" style={{ textAlign: "left" }}>
                    ...
                    <ul class="flex ml-36 border-b-2 border-blue-950  ">
                        <li
                            ...
                            onClick={() => {
                                setDark("drive");
                                setContent({
                                    text: " Get noticed, and never miss an opportunity to connect with prospects.",
                                    img: "https://53.fs1.hubspotusercontent-na1.net/hubfs/53/assets/hubspot.com/core-2020/sales/jtbd/Image1.png",
                                });
                            }}
                        >
                            Start Conversations
                        ...
                        <li
                            ...
                            onClick={() => {
                                setDark("resources");
                                setContent({
                                    text: "Build trust and establish lasting relationships.",
                                    img: "https://53.fs1.hubspotusercontent-na1.net/hubfs/53/assets/hubspot.com/core-2020/sales/jtbd/Image4.png",
                                });
                            }}
                        >
                        ...
                        <li
                            ...
                            onClick={() => {
                                setDark("optimize");
                                setContent({
                                    text: "Automate administrative tasks, and get full visibility into the health of your business.",
                                    img: "https://www.hubspot.com/hubfs/Sales-Hub-manage-pipeline.jpeg",
                                });
            ...
            <div className='opacity-90 m-auto h-[38vh] text-white' style={{ backgroundImage: ' url(https://53.fs1.hubspotusercontent-na1.net/hubfs/53/assets/hubspot.com/core-2020/sales/multi-col%20bg%20image.jpg)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', zIndex: '1', backgroundPosition: '50%', position: 'absolute', left: '0', right: '0' }}>
                <h1 className='text-center pt-24 font-bold text-3xl leading-3' style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.7)' }}>We've got your back — every step of the way.</h1>
                <p className='text-center mt-8 font-bold text-md ' style={{ textShadow: '1px 1px 2px rgba(0, 0, 0, 0.7)' }}>Because you shouldn't have to figure it out on your own.</p>
            </div>
            ...
            <div className="bg-blue-100 pt-80 ">
                <div className="m-auto w-[75vw]">
                    ...
                    Start with free tools and upgrade as you grow, or hit the ground running with one of our<br /> premium editions.
                    </p>
            ...
            <div className='bg-white m-auto w-[80%] pb-24'>
                <h1 className='pt-1 font-bold text-3xl text-center' style={{color:"black"}}>How HubSpot Customers Are Connecting</h1>
